...
def main():
    ...
    processes = [
        {'arrival_time': 0, 'burst_time': 30, 'priority': 3},
        {'arrival_time': 10, 'burst_time': 20, 'priority': 5},
        {'arrival_time': 15, 'burst_time': 40, 'priority': 2},
        {'arrival_time': 20, 'burst_time': 15, 'priority': 4},
    ]
